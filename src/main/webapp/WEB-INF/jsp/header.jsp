...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="${contextRootPath}">도서 관리 시스템</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="${contextRootPath}/app/library/">도서 관리 시스템</a></li>
    </ul>
    ...
    <div id="bit-login-state">
      ...
      <c:if test="${not empty loginUser}">
        <img src='${contextRootPath}/upload/member/${loginUser.photo}' style='height:20px;'>
        ${loginUser.name}
